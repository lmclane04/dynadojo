...
class GilpinFlowsSystem(AbstractSystem):
    ...
    def __init__(self, latent_dim=3, embed_dim=3, system_name="Lorenz", params=None, pts_per_period=100, seed=None):
        """
    ...
    def make_data(self, init_conds: np.ndarray, timesteps: int, control=None, noisy=False):
        ...
        for i in range(n):
            ...
            trajectory = self.system.make_trajectory(timesteps, pts_per_period=self.pts_per_period, method="BDF")
